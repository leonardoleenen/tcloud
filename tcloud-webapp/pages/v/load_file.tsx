...
export default () => {
  ...
  return (<div className="h-screen v-screen bg-indigo-100 flex flex-col"> 
    <div className="m-auto">
      <div className="m-auto bg-white w-64 h-48  "  >
        <IconDownload/> 
        <p className="m-auto">Arrastre un archivo aqui</p>
        <div className="flex ">
      ...
      <p className="m-auto mt-4 "> O <span className="underline">Seleccione un archivo</span> </p>
